...
class VenderController extends Controller
{
    ...
    public function credito(Request $request, $idProducto)
    {
      ...
      else
      {
       ...
       $urlCredito = "http://190.145.4.62/WebServices/WSAppFinancial.asmx/GrabarCredito?pEntidad=FONSODI&pCod_Persona=".$request->codigo."&pMontoSoli=".$serieTotalValor."&pPlazo=".$request->cuotas."&pTipoCredito=8&pPeriodicidad=1&pDestino=".$producto->producto_provedor->codigo."&pFormaPago=2&pEmpresa=1&pCod_Oficina=1&pObservacion=&pVr_compra=".$serieTotalCompra."&pVr_beneficio=".$beneficio."&pVr_Mercado=".$serieTotalPublico."&pIdentProveedor=".$producto->producto_provedor->nit."&pCodProceso=".$pCodProceso;       
