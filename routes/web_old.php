...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'asociado'], function () {
       ...
       // Route::post('solicitud/solicitar', 'SolicitudProducto\SolicitudController@store');
        ...
        //Rutas polla mundial
        Route::get('predictions/createe')->uses('Usuario\PollaController@create')->name('predictions.create');
        Route::post('predictions/storee')->uses('Usuario\PollaController@store')->name('predictions.store');
        Route::get('predictions/{pollaa}')->uses('Usuario\PollaController@show')->name('predictions.show');
