...
class InformeController extends Controller
{
  ...
  public function index()
  {
    if (Auth::guard('admin_user')->user()->role_id <= 3 ) {
      ...
      return view('adminlte::admin_boleteria.informe.coordinador',compact('ventatotal','inventario','pendientes','valorventas',
                                                                          'enero','febrero','marzo','abril',
                                                                          'mayo','junio','julio','agosto',
                                                                          'septiembre','octubre','noviembre','diciembre', 'valorcompra','ahorrofondo', 'ahorroasociados',
                                                                          'ano','ventatablas'));
  ...
  public function serialesexcel()
  {
        ...
        Excel::create('Seriale', function($excel) use($result) {

          $excel->sheet('Seriale', function($sheet) use($result) {
